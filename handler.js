...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|ai|isagi|a|s)/gi)) {
...
global.dfail = (type, m, conn) => {
  ...
  unreg: `🏔️ 𝗘𝗹 𝗰𝗼𝗺𝗮𝗻𝗱𝗼「 *${comando}* 」𝘀𝗼𝗹𝗼 𝗽𝘂𝗲𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗽𝗼𝗿 𝗹𝗼𝘀 𝘂𝘀𝘂𝗮𝗿𝗶𝗼𝘀 𝗿𝗲𝗴𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝘀\n\n\`\`\`_🌴 Utiliza 📚_:\`\`\`\n> » *#${verifyaleatorio} ${user2}.${edadaleatoria}*`,
